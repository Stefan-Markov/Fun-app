    ...
    return (
        <div className={'wrap-main'}>
            ...
            <div className={'profile'}>
                <p className={'futura'}><i className="fas fa-user"></i><span className={'account-data'}> Username:</span> {usernameData}</p>
                <p className={'futura'}>    <i className="fas fa-envelope-open"></i><span className={'account-data'}> Email:</span> {email}</p>
                <p className={'futura'}><i className="far fa-address-book"></i><span className={'account-data'}> User ID:</span> {user.id}</p>
                {date === 'Invalid date' ? '' :
                    <p className={'futura'}><i className="far fa-calendar-alt"></i><span className={'account-data'}> Date joined:</span> {date}</p>}
                <p className={'futura'}><i className="fas fa-user-shield"></i><span className={'account-data'}>Roles:</span> {roles}</p>
            </div>
